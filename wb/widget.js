(function (global) {
    ...
    function resolveDataUrl(config, baseOrigin) {
        ...
        const jsonUrl = config.jsonUrl || `${origin}/yelp-reviews.json`;
        return { jsonUrl, apiUrl: config.apiUrl || null };
    }
    ...
    function init(container, config) {
        ...
        async function loadReviews() {
            try {
                ...
                showError('Could not load Yelp reviews. Check that yelp-reviews.json is hosted at the same URL as the widget.');
            }
        }
